...
(function () {
  ...
  var SHOW = {
    ...
    showType: "多演目ショーケース", showSub: "複数演目＋コラボ／全1幕・休憩なし",
  ...
  var DEADLINES = {
    ...
    team:      "9/27",   // 団体（5名〜）の申込の最終日（2026-09-26 再開放で9/12から変更）
  ...
  var TICKETS = [
    ...
    /* 2026-09-01 配信を全面中止（決定No.37・ADR-015）したため、券種表から
       「生配信 ¥1,000」「配信サポーター ¥10,000」の2要素を削除した。
       旧経緯：2026-08-06 に販売開始し、2026-08-24 まで公式サイトに載っていなかった。
       英語版（global.haribow.com）だけが "On sale now — $17" と出ていた。 */
  ];
