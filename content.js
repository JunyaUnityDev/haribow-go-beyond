...
(function () {
  ...
  var LINEUP = [
    ...
    { tags: [{ t: "限定コラボ", c: "red" }], title: "Special Guest Collaboration", img: null,
  ...
  var TICKETS = [
    { name: "一般", pre: "¥3,500", reg: "¥4,000" },
    { name: "メイン", tag: "サンクス動画付", pre: "¥4,500", reg: "¥5,000" },
    { name: "大学生（個人）", pre: "¥2,500", reg: "¥3,000" },
    { name: "大学生 団体", sub: "5名以上", price: "¥2,000" },
    { name: "コミュニティ団体", sub: "5名以上", price: "¥3,000" },
    { name: "高校生・子供（小中学生）", price: "一般価格" },
    { name: "サポーター券", sub: "2列中央12席・特典付", price: "¥15,000" },
    { name: "未就学児", price: "無料" }
  ];
